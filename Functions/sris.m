function [t_out, x_out, P_out] = sris(F, Gamma, H, Q, R, xhat0, P0, z)
...
% Initialize outputs (may not be the same for sris as srif)
...
Rvv_bar = zeros(nv, nv, num_meas);
Rvx_bar = zeros(nv, nx, num_meas);
...
% This is going to be so quick to implement
